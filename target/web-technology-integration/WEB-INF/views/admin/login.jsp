    ...
    <div class="col-md-6">
        ...
        <form id="login-form" class="login-form" action="${ctx}/admin/login" method="post">
            ...
            <div class="form-group">
                ...
                <div class="input-icon">
                    ...
                    <input class="form-control placeholder-no-fix" type="text" autocomplete="off"
                           ...
                           required="true" data-msg-required="请填写登录账号"/>
                </div>
            </div>
            <div class="form-group">
                    ...
                    <div class="input-group">
                        <div class="input-icon">
                            ...
                            <input class="form-control captcha-text" type="text" autocomplete="off"
                                   placeholder="验证码...看不清可点击图片可刷新" name="captcha"
            ...
            <div class="form-actions">
                <label>
                    <input type="checkbox" name="rememberMe" checked="true" value="true"/>
                    记住我，下次自动登录
                </label>
        ...
        <div class="form-info" style="height: 270px; margin-top: 50px">
            ...
            <c:if test="${cfg.dev_mode}">
                <p id="devModeTips" style="padding: 10px">
                    <b>
                        开发/测试/演示登录快速入口: <br/> <br/>
                        <a href="javascript:void(0)" onclick="setupDevUser('admin','admin123')">admin超级管理员(admin/admin123)</a>
                    </b>
                </p>

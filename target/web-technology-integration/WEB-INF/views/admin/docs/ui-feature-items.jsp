...
<div class="note note-info">
    <ul>
        <li>UI示例组件对应源码请直接参考对应代码：src\main\webapp\WEB-INF\views\admin\docs\ui-feature-items.jsp和
            com.rascal.support.web.DocumentController
        </li>
        <li>点击元素后方的"JSDoc"链接可查看组件的具体用法Javascript注释文档</li>
        <li>
            鼠标双击portlet标题区域可以切换单个展开或收拢
            ...
            <form:form class="form-horizontal form-bordered form-label-stripped form-validation" action="${ctx}/todo"
                ...
                <div class="form-body">
                    ...
                    <div class="row">
                        <div class="col-md-10">
                            <div class="form-group">
                                <label class="control-label" data-tooltips="[输入你想要提示说明内容]"
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-2">
                        <span class="help-block">
                            <a href="${ctx}/docs/jsdoc/global.html#initDataProfileParam"
                ...
                <div class="form-body">
                    ...
                    <div class="row" data-equal-height="false">
                            ...
                            <div class="form-group">
                                ...
                                <div class="controls">
                                    <input type="text" class="form-control" name="startDate" required="true"
                                           data-rule-dateLT="endDate" data-picker="date">
                            ...
                            <div class="form-group">
                                ...
                                <div class="controls">
                                    <input type="text" class="form-control" name="endDate" required="true"
                                           data-rule-dateGT="startDate" data-picker="date">
                                    <span class="help-block">日期前后关系关联校验</span>
                                </div>
                            </div>
                            <div class="form-group">
                        ...
                        <div class="col-md-6">
                            ...
                            <span class="help-block">
                                <a href="${ctx}/docs/markdown/表单控制#jsr303" target="_blank">集成服务端和客户端的Form/DataValidation的设计处理</a>
                            </span>
                            <span class="help-block">
                                <a href="${ctx}/docs/markdown/表单控制#rules"
                                   target="_blank">基于JQueryValidation及扩展的校验语法规则定义</a>
                            </span>
                            <span class="help-block">
                                ...
                                <div class="controls">
                                    <div class="input-group">
                                        <div class="input-icon">
                                            ...
                                            <input class="form-control captcha-text" type="text" autocomplete="off"
                    ...
                    <div class="row">
                        <div class="col-md-10">
                            <div class="form-group">
                                ...
                                <div class="controls">
                                    <form:select path="selectedId" items="${multiSelectItems}"
                    ...
                    <div class="row">
                        <div class="col-md-10">
                            <div class="form-group">
                                ...
                                <div class="controls">
                                    <form:input path="selectedId" class="form-control" data-select2-type="remote"
                                                data-display="${'当前显示字面值'}"
                                                data-url="${ctx}/admin/auth/user/list"
                                                data-query="search['CN_authUid_OR_nickName_OR_email_OR_mobile']"/>
                                </div>
                            </div>
                        </div>
                        <div class="col-md-2">
                            ...
                            <div class="form-group">
                                ...
                                <div class="controls">
                                    <div data-qrcode="${webContextFullUrl}/admin"
                                         data-qrcode-icon="${ctx}/assets/img/favicon.ico"
                    ...
                    <div class="row">
                        <div class="col-md-10">
                            <div class="form-group">
                                ...
                                <div class="controls">
                                    <div class="gmaps gmaps-baidu gmaps-demo-location" data-location="成都信息工程大学航空港校区"/>
                                </div>
                            </div>
                        </div>
                        <div class="col-md-2">
                    ...
                    <div class="row">
                        <div class="col-md-10">
                            <div class="form-group">
                                ...
                                <div class="controls">
                                    <input type="text" class="form-control" name="location" value="成都信息工程大学航空港校区">
                    ...
                    <div class="row">
                        <div class="col-md-10">
                            <div class="form-group">
                                ...
                                <div class="controls">
                                    <input type="text" class="form-control" name="longitude" value="103.9959850000">
                    ...
                    <div class="row">
                        <div class="col-md-10">
                            <div class="form-group">
                                ...
                                <div class="controls">
                                    <input type="text" class="form-control" name="latitude" value="30.5857340000">
                                    <span class="help-block">点击地图更新坐标信息</span>
                                </div>
                            </div>
                        </div>

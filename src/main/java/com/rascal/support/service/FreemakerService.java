...
@Service
public class FreemakerService extends Configuration {

    private final static Logger logger = LoggerFactory.getLogger(FreemakerService.class);
    ...
    private String processTemplateByName(String templateName, Map<String, Object> dataMap) {
        ...
        try {
            this.getTemplate(templateName).process(dataMap, stringWriter);
            stringWriter.flush();
    ...
    public String processTemplateByFileName(String templateFileName, Map<String, Object> dataMap) {
        ...
        logger.debug("Processiong frrmarker template file: {}", targetTemplateFile.getAbsoluteFile());

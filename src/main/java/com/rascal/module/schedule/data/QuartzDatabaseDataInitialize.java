package com.rascal.module.schedule.data;
        ...
        try {
            ...
            try {
                ...
                if (name.contains("mysql")) {
                    sqlFile = "com/rascal/module/schedule/data/quartz/tables_mysql.sql";
                    ...
                    sqlFile = "com/rascal/module/schedule/data/quartz/tables_h2.sql";
                    ClassPathResource resource = new ClassPathResource(sqlFile);
                    resourceDatabasePopulator = new ResourceDatabasePopulator(resource);
                } else if (name.contains("microsoft") || name.contains("sql server")) {
                    //In your Quartz properties file, you'll need to set 
                    //org.quartz.jobStore.driverDelegateClass = org.quartz.impl.jdbcjobstore.MSSQLDelegate
                    sqlFile = "com/rascal/module/schedule/data/quartz/tables_sqlServer.sql";
                    ClassPathResource resource = new ClassPathResource(sqlFile);
                    resourceDatabasePopulator = new ResourceDatabasePopulator(resource);
                    ...
                    sqlFile = "com/rascal/module/schedule/data/quartz/tables_oracle.sql";
                    ClassPathResource resource = new ClassPathResource(sqlFile);
                    resourceDatabasePopulator = new ResourceDatabasePopulator(resource);
                }

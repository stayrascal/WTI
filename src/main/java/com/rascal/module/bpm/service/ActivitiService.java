package com.rascal.module.bpm.service;

import com.google.common.collect.Lists;
import com.google.common.collect.Maps;
import com.rascal.core.security.AuthContextHolder;
import com.rascal.module.bpm.BpmTrackable;
...
public class ActivitiService {
    ...
    private List<String> getHighLightedFlows(ProcessDefinitionEntity processDefinition, String processInstanceId) {
        ...
        historicActivityInstanceList.addAll(historicActivityInstances.stream().
    ...
    public String findActiveTaskNames(String bizKey) {
        ...
        activeActs.addAll(activityImpls.stream().filter(activityImpl ->
                ids.contains(activityImpl.getId())).map(activityImpl ->
                ObjectUtils.toString(activityImpl.getProperty("name"))).collect(Collectors.toList()));
    ...
    private List<PvmTransition> clearTransition(ActivityImpl activityImpl) {
        ...
        oriPvmTransitionList.addAll(pvmTransitionList.stream().collect(Collectors.toList()));
        /*for (PvmTransition pvmTransition : pvmTransitionList) {
    ...
    private void restoreTransition(ActivityImpl activityImpl, List<PvmTransition> oriPvmTransitionList) {
        ...
        pvmTransitionList.clear();
        // 还原以前流向    
        pvmTransitionList.addAll(oriPvmTransitionList.stream().collect(Collectors.toList()));

var App = function () {
    ...
    var D = function () {
        ...
        $(".page-sidebar").off("mouseenter").on("mouseenter", function () {
            ...
            $(this).animate({width: f}, 400, "", function () {
        ...
        $(".page-sidebar").off("mouseleave").on("mouseleave", function () {
            ...
            $(this).addClass("page-sidebar-hovering");
            $(this).animate({width: l}, 400, "", function () {
    ...
    var i = function () {
        ...
        jQuery("body").on("show.bs.collapse", ".accordion.scrollable", function () {
            jQuery("html,body").animate({scrollTop: L.offset().top - 150}, "slow")
        })
    };
    var I = function () {
    ...
    var a = function () {
        ...
        var M = function (Q) {
            $("#style_color").attr("href", WEB_ROOT + "/assets/admin/css/themes/" + Q + ".css");
    ...
    return {
        init: function () {
            ...
            jQuery("html,body").animate({scrollTop: pos + (L ? L : 0)}, "slow")
        }, scrollTop: function () {
            App.scrollTo()

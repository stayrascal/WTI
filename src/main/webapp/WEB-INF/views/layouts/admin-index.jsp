...
<div class="header navbar navbar-inverse navbar-fixed-top">
    ...
    <div class="header-inner">
        ...
        <ul class="nav navbar-nav pull-right">
            ...
            <li class="dropdown hide">
                <a href="#" class="dropdown-toggle" data-toggle="dropdown" data-hover="dropdown"
                   data-close-others="true">
                    <i class="fa fa-warning"></i> <span class="badge"> 0 </span>
                </a>
            ...
            <li class="dropdown user" style="padding-top: 5px; margin-right: 25px">
                <a href="javascripts:;" rel="address:/admin/profile/edit|个人配置" class="dropdown-toggle"
    ...
    <div class="theme-panel hidden-xs hidden-sm" style="margin-top: -3px; position: absolute; right: 0px">
        ...
        <div class="theme-options">
            ...
            <div class="theme-option">
                <span>右键菜单</span>
                <select class="context-menu-option form-control input-small"
            ...
            <div class="theme-option">
                <span>表格布局</span>
                <select class="grid-shrink-option form-control input-small"
        ...
        <div class="page-sidebar navbar-collapse collapse collapse">
            ...
            <ul class="page-sidebar-menu">
                <li>
                    ...
                    <div class="sidebar-toggler hidden-phone" style="margin-top: 5px; margin-bottom: 5px"></div>
                    <!-- BEGIN SIDEBAR TOGGLER BUTTON -->
                </li>
                <li>
...
<div class="footer">
    <div class="footer-inner">
        &copy; Web Techology Integration 2015

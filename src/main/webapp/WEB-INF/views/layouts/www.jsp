...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="${ctx}/assets/plugins/data-tables/DT_bootstrap.css"/>
    <link href="${ctx}/assets/plugins/bootstrap-daterangepicker/daterangepicker-bs3.css" rel="stylesheet"
          type="text/css"/>
            ...
            <div class="row">
                <div class="col-md-6 col-sm-6">
                    <ul class="list-unstyle inline">
                        <li>QQ:
                            <span><a href="#">1024652843</a></span>
                        </li>
                        <li class="sep"><span>|</span></li>
                        <li>
                            <i class="fa fa-envelope-o topbar-info-icon top-2"></i>
                            Email: <span><a href="mailto:stayrascal@gmail.com">stayrascal@gmail.com</a></span>
                        </li>
                        <li class="sep"><span>|</span></li>
                ...
                <div class="col-md-6 col-sm-6 login-reg-links">
                    <ul class="list-unstyled inline">
                        ...
                        <shiro:user>
                            <li>
                                <a href="${ctx}/w/user">
                                    <shiro:principal property="nickName"/> ( <shiro:principal property="authUid"/> )
                                </a>
                            </li>
                            <li class="sep"><span>|</span></li>
                            <li>
                                <a href="javascript:" rel="address:/w/message/list">
                                    我的消息<span id="message-count-alert"></span>
                                </a>
                            </li>
                            <li class="sep"><span>|</span></li>
...
<div class="copyright">
    <div class="container">
        <div class="row">
            <div class="col-md-8">
                <p>
                    <span class="margin-right-10">2015 © WEI. ALL Rights Reserved.</span> <a
                        href="mailto:stayrascal@gmail.com">联系作者</a>
                </p>
            </div>
            <div class="col-md-4">
                <p>

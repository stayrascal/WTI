...
<form:form class="form-horizontal form-bordered form-label-stripped form-validation"
           action="${ctx}/admin/sys/data-dict/edit?parent.id=${param['parent.id'] != null ? param['parent.id'] : 1}" method="post"
        ...
        <div class="row">
            <div class="col-md-12">
                <div class="form-group">
                    ...
                    <div class="controls">
                        <form:textarea path="richTextValue" class="form-control" data-htmleditor="kindeditor"
                                       data-height="400px"
                                       id="htmlValue"/>
                    </div>
                </div>
